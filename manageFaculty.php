        ...
        <table class="tablecontent">
          ...
          <tbody id="tbody">
            ...
            foreach ($result as $cols) {
              ...
              echo "<td><a href='hodedit.php?fname=$cols[fname]' name='edit'><i class='fa-solid fa-pen-to-square edit'></i></a></td>";
              echo "<td><a href='hoddelete.php?fname=$cols[email]' name='delete'><i class='fa-solid fa-trash delete'></i></a></td>";
              echo "</tr>";
              $i++;
            }
            ?>
      ...
      function display_student() {
        ...
        tbody.innerHTML = "<?php
                            ...
                            foreach ($result as $cols) {
                              ...
                              echo "<td>$cols[lname]</td>";
                              echo "<td>$cols[email]</td>";
                              echo "<td><a href='hodedit.php?fname=$cols[fname]' name=edit><i class='fa-solid fa-pen-to-square edit'></a></td>";
                              echo "<td><a href='hoddelete.php?email=$cols[email]' name=delete><i class='fa-solid fa-trash delete'></i></a></td>";
                              echo "</tr>";
                              $i++;
                            } ?>";
      }
